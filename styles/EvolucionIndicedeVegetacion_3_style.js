...
var style_EvolucionIndicedeVegetacion_3 = function(feature, resolution){
    ...
    if (value >= -0.134814 && value <= -0.069010) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.069010 && value <= -0.003207) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.003207 && value <= 0.062597) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.062597 && value <= 0.128400) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.128400 && value <= 0.194204) {
            style = [ new ol.style.Style({
