...
var style_IndicedeHumedad_2 = function(feature, resolution){
    ...
    if (value >= -0.207240 && value <= -0.095286) {
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= -0.095286 && value <= 0.016667) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.016667 && value <= 0.128621) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.128621 && value <= 0.240575) {
            style = [ new ol.style.Style({
        ...
        text: createTextStyle(feature, resolution, labelText, labelFont,
                    ...
                    } else if (value >= 0.240575 && value <= 0.352528) {
            style = [ new ol.style.Style({
